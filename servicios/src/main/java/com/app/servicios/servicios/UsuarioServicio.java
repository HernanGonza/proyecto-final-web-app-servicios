...
public class UsuarioServicio implements UserDetailsService {
    ...
    public void registrarCliente(String nombre, String apellido, long id, String direccion, String localidad, String barrio, Integer telefono, String email, String password, String password2) throws MiExcepcion {
        validarAtributosCliente(nombre,apellido,direccion,localidad,barrio,telefono,id, email, password, password2);
        ...
        usuarioRepositorio.validarCliente(usuario.getEmail(),password,password2);
    }
    ...
    private void validarAtributosCliente(String nombre, String apellido, long id, String direccion, String localidad, String barrio, Integer telefono, String email, String password, String password2) throws MiExcepcion {
        if (nombre.isEmpty() || nombre == null) {throw new MiExcepcion("El nombre no puede ser nulo o estar vacío");}
        if (apellido.isEmpty() || apellido == null) {throw new MiExcepcion("El apellido no puede ser nulo o estar vacío");}
        if (telefono == null) {throw new MiExcepcion("El teléfono no puede ser nulo o estar vacío");}
        if (telefono <= 0 ) {throw new MiExcepcion("El teléfono no puede ser nulo o estar vacío");}
        ...
        if (direccion.isEmpty() || direccion == null) {throw new MiExcepcion("La dirección no puede ser nula o estar vacía");}
        if (localidad.isEmpty() || localidad == null) {throw new MiExcepcion("La localidad no puede ser nula o estar vacía");}
        if (barrio.isEmpty() || barrio == null) {throw new MiExcepcion("El barrio no puede ser nulo o estar vacío");}
        if (email.isEmpty() || email == null) {throw new MiExcepcion("El email no puede ser nulo o estar vacío");}
        if (password.isEmpty() || password == null || password.length() <= 5) {throw new MiExcepcion("La contraseña no puede estar vacía, y debe tener más de 5 digitos");}
    ...
    public void registrarProveedor(String nombre, String apellido, long id, String direccion, String localidad, Set<Servicio> servicios, String barrio, Integer telefono, String email, Integer dni, Integer experiencia, String password, String password2, String descripcion) throws MiExcepcion {
        validarAtributosProveedor(nombre,apellido,direccion,localidad,barrio,telefono,id, email, password, password2);
        ...
        // Se le da el rol de proveedor de manera predeterminada
        usuario.setRol(Rol.PROVEEDOR);

        usuarioRepositorio.save(usuario);
        usuarioRepositorio.validarProveedor(usuario.getEmail(),password, password2);
    }
    ...
    private void validarAtributosProveedor(String nombre, String apellido, long id, String direccion, String localidad, Set<Servicio> servicios, String barrio, Integer telefono, String email, Integer dni, Integer experiencia, String password, String password2, String descripcion) throws MiExcepcion {
        ...
        //DNI:
        if (dni == null) {throw new MiExcepcion("Dato requerido a proveedores");}
        if (dni <= 0 ) {throw new MiExcepcion("El teléfono no puede ser nulo o estar vacío");}
        // Validación que el telefono cumpla con la longitud:
        ...
        //Experiencia:
        if (experiencia == null) {throw new MiExcepcion("Dato requerido a proveedores");}
        if (experiencia <= 0 ) {
            throw new MiExcepcion("Los Años de experiencia deben ser un número positivo mayor de cero");}
        //Descripcion:
        if (descripcion.isEmpty() || descripcion == null) {throw new MiExcepcion("Dato requerido a proveedores");}
    }
